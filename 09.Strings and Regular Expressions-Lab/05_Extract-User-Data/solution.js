function solve() {
  let inputContent = JSON.parse(document.getElementById('arr').value);
  let result = document.getElementById("result");

  console.log(inputContent);
  let pattern = /(^[A-Z][a-z]*\s[A-Z][a-z]*) (\+359 [0-9] [0-9]{3} [0-9]{3}|\+359-[0-9]-[0-9]{3}-[0-9]{3}) ([a-z0-9]+@[a-z]+\.[a-z]{2,3}$)/gm;
  let match;
  for (let str of inputContent) {
